// Auto-generated shim — re-exports from @/lib/upsc-cse-prelims/config
// This lets shared ecosystem components import from "@/lib/act/config"
import type { ExamConfig as _upsc_cse_prelims_Config } from "@/lib/upsc-cse-prelims/config";
import { EXAM_CONFIG as _raw } from "@/lib/upsc-cse-prelims/config";
