...
export const metadata: Metadata = {
  title: "Pricing — Upsc Cse Prelims Premium",
  description: "Unlock unlimited Upsc Cse Prelims practice with Koydo Premium.",
};

export default function PricingPage() {
  const checkoutUrl = `https://koydo.app/pricing?exam=upsc-cse-prelims&cadence=annual`;
