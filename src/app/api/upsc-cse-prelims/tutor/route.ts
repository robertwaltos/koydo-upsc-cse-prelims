...
const EXAM_ID = "upsc-cse-prelims";
const EXAM_DISPLAY_NAME = "UPSC CSE Prelims (Civil Services Examination)";

const TUTOR_SYSTEM_PROMPT = `You are an expert AI tutor for ${EXAM_DISPLAY_NAME}. Respond in English.

Cover General Studies Paper I (History, Geography, Polity, Economy, Environment, Science, Current Affairs) and CSAT Paper II. Align to UPSC CSE Prelims syllabus.
