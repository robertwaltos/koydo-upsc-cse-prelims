...
export const metadata: Metadata = {
  title: "Learn — UPSC CSE Prelims Practice",
  description: "Study and practice for UPSC CSE Prelims. Choose your subject and start preparing.",
};
